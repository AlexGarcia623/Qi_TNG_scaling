...
#spx_metal = np.log10(spx_metal * 0.0127 * 0.35 / 16 / 0.75) + 12.0
...
#z = np.log10(z * 0.0127 * 0.35 / 16 / 0.75) + 12.0
#z1 = np.log10(z1 * 0.0127 * 0.35 / 16 / 0.75) + 12.0
#z2 = np.log10(z2 * 0.0127 * 0.35 / 16 / 0.75) + 12.0
...
califa_mass, califa_z = np.loadtxt('califa.txt', usecols=(0, 1), unpack=True)
manga_mass, manga_z = np.loadtxt('manga.txt', usecols=(0, 1), unpack=True)
